...
created.](images/user-flow-table-metadata-creation.png)
...
created.](images/user-flow-column-metadata-creation.png)
...
table.](images/user-flow-validation-table-completeness.png)
...
steps.](images/user-flow-table-created-continue-to-upload.png)
...
existing
table.](images/user-flow-prepare-to-upload-using-existing-table.png)
...
upload from a Data Contributor.](images/user-flow-data-upload.png)
...
being stored in the database.](images/user-flow.png)
