...
Is a Python class with nested dataclasses that is used to help create
properties objects used throughout Sprout. It mains is used for users to
identify what fields are available to include, what are required, and to
provide a way of creating correct properties that follow the
