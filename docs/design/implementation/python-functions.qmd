...
Is a Python class with nested dataclasses that helps create
properties objects used throughout Sprout. Its main purpose is so that users
...
<!-- TODO: Not going to repeat docs here, this can be auto-generated from Data Package -->
:::
