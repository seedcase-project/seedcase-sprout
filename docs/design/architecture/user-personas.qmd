...
the different types of hypothetically real-world users and their needs
with Sprout.
...
-   Background: Liam is a software developer with expertise in building
    ...
    ensuring the smooth flow of data, so that they can be feed into
...
-   Background: Dr. Garcia is a senior researcher within an academic
    university. She has extensive experience in managing research
...
-   Background: Chen Wei is a research data manager with a strong
    ...
    needing to balance specific needs of the different projects and how
