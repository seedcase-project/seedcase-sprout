...
-   Types of core objects: packages, resources, properties (data package metadata), and data.
-   Types of actions taken on those objects: create, view, edit (a
    file), add (data in the package), list, and delete.
...
:   Create the folder and file structure for a new package, as well as
    the overall properties metadata that describes the package. 

`package_edit(package_id, properties)`

:   Edit the properties metadata of the specific package.
...
:   Create a new resource in a specific package using data and the properties metadata.
...
:   View the landing page of a specific package.

`packages/<id>/edit`

:   Edit the properties metadata of a specific package.
...
:   Create a new resource with associated data and properties metadata in a specific
    package.

`packages/<id>/resources/<id>`

:   View the details of a specific resource in a specific
    package as a landing page.
...
-   `resources/<id>/`: The files related to a specific table or file.
