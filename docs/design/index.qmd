...
1.  Take generated data from various source locations (such as the
    ...
    format.
2.  Require metadata be included for the data and organized following a
    standardized format, in a way that explicitly and programmatically
    links the metadata to the data.

The purpose of these documents are to describe the overall design of
Sprout in enough detail to primarily help us develop Sprout in a way
