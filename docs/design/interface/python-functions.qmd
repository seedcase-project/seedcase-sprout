...
::: {.callout-note collapse="true"}
### `write_resource_data_to_raw(data_path, path, resource_properties)`
...
```{mermaid}
flowchart
    in_data_path@{shape: lean-r, label: "data_path"}
    in_path@{shape: lean-r, label: "path"}
    in_properties@{shape: lean-r, label: "resource_properties"}
    function@{shape: rect, label: "write_resource_data_to_raw()"}
    out@{shape: lean-r, label: "{path}/{timestamp}-{uuid}.{ext}.csv"}
