...
We follow our
[naming scheme](/docs/design/architecture/naming.qmd#naming), as well as
the
[Frictionless Data specification](https://decisions.seedcase-project.org/why-frictionless-data/),
...
:   Whenever a specific type of data, like demographics data or blood
    ...
    ::: callout-note
Using the demographics and blood sample example above, the reason why
these sources of data would be considered two separate data resources,
rather than a single, joint data resource, is because, while they both
collect data on the same group of people, they collect the data in
different ways. Demographic data is usually collected with a survey by a
researcher or technician (or the participants themselves if online) in a
relatively consistent way using some survey software. Meanwhile, blood
...
different ways and should be recognized as separate entities and thus
separate data resources, even though they contain data about the same
group of people.
    :::
