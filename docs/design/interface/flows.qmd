...
flowchart
    ...
    subgraph Internal
        ...
        check_column_values_types("_check_column_values_types()")
        check_column_values_constraints("_check_column_values_constraints()")
        string[("string, with<br>error message")]
    end

    data --> check_data
    resource_properties --> check_data
    check_data -.-> Internal
    check_column_names -.-> string
    check_column_types -.-> string
    check_column_values_types -.-> string
    check_column_values_constraints -.-> string
```
