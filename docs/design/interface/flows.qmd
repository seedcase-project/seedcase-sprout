...
A data resource needs data, not just properties. As long as there is the
resource properties, you can add data to the resource. Whenever data is
...
-   A new data resource is created and raw data is added to it.
-   Additional raw data is added to an existing data resource.
-   You need to fix or update or modify existing data in the resource by
