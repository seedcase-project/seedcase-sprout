...
you can use `write_resource_batches()` to save the updated data back to the
batch files.

<!-- TODO: I'm not completely clear yet how this flow might work. Does it overwrite existing ones? Or delete? -->
...
flowchart
    ...
    list_data_updated --> write_resource_batches
    properties_updated --> write_resource_batches
```
