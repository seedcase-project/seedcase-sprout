...
describes the main functions and classes that make up the interface,
this document describes and shows how all these objects work together
and flow into one another, but not necessarily the functions' exact
input and output. Those are already described in the
[functions](functions.qmd#functions) document.
...
script directly and then run your main script again to overwrite the
...
## Check the properties of packages or resources
...
## Save new or modified data to batch
...
## Modify data types or table schema
