...
describes the main functions and classes that make up the interface in detail including their input and output,
...
script with the properties directly and then rerun your main script to overwrite the
