...
haven't been filled in yet. This command is meant to be used to start filling
out some metadata when none yet exists. It creates a Python script with empty
