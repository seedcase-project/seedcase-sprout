...
of structuring and sharing data. This guide will show you how to create
...
The first thing you'll need to decide is where you want to store
...
Afterwards, you will create the structure for your first data package
like so:
...
# Save the package properties to the `datapackage.json` file
