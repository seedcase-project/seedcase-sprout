...
location to be `~/Desktop/sprout/`. You can set this in your
...
# TODO: function to assign path to root? Since this doesn't know about `~`
os.environ["SPROUT_ROOT"] = "~/Desktop/sprout/"
# TODO: need function setup Sprout.
pathlib.Path("~/Desktop/sprout/packages").mkdir(parents=True, exist_ok=True)
```
...
properties = sp.PackageProperties(
    ...
    licenses=[sp.LicenseProperties(name="ODC-BY-1.0")]
)
print(properties)
```
