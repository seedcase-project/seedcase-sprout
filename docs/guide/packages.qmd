...
a `datapackage.json` file yet. Before you can create one, you
...
create an `__init__.py` file in the `scripts/` folder. In your Terminal,
...
The core of a data package is its properties. Without these, your data
...
is an example of a set of properties with required fields filled in (including the
...
your data package's `diabetes-study` folder, which contains the properties
