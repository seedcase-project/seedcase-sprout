...
3. We have removed the writing of `datapackage.json` and the creation of the
   ...
   data-level metadata and the readme later in this guide.
...
1. Write `datapackage.json` (including both the project-level and data-level metadata).
...
All the data-level metadata is now also saved in this file! If you need to
