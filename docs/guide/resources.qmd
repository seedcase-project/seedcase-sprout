...
Putting your data into a data package makes it easier for yourself
...
from the Polars DataFrame with your data. Afterwards, you can edit these properties as needed.
...
As shown above, the data is currently stored loaded as a Polars DataFrame called `data`. Now, it's time to store this data in the resource's folder by
using:
