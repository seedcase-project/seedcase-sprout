...
following the [package guide](packages.qmd)) and stored the path to it as a `PackagePath` object
in the `package_path` variable. In this guide, the root folder of the package is a temporary folder:
