...
def main():
    ...
    sp.write_properties(properties=package_properties)               # <3>
...
2. This is the only new line of code. It creates the resource properties script.
   ...
   already exists.
3. We already had this line in our script from the previous section of the guide.
4. Here, we temporarily removed the creation of the README file to make it easier to
   see what is new.
...
## Extracting column metadata from data
