...
In the code snippet below, we have added all the required steps to our `main.py` file.
...
2. Clean the data until the name and data type of each column is satisfactory.
