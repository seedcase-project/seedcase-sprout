...
to use the Terminal. If you unfamiliar with the terminal, start with our
...
negatively effect other Python packages. Rather, you install a package
...
If it installed successful, it will show details about Sprout.
