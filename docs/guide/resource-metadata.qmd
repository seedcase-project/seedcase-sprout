...
by using the `write_resource_batch()` function in the `main.py` file.
...
file. The functions to use are `read_resource_batches()`,
`join_resource_batches()`, and `write_resource_data()`. Several of these
