...
properties object (`SproutProperties` or `ResourceProperties`) as
...
```{python}
#| error: true
properties = sp.SproutProperties(
    name="woolly-dormice",
    title="Hibernation Physiology of the Woolly Dormouse: A Scoping Review.",
    id="123-abc-123",
    created="2014-05-14T05:00:01+00:00",
