...
- :recycle: use `file_tree()` from `seedcase_soil` (#1712)
...
- ♻️ rename `Properties` classes to be more specific (#1698)
...
- ♻️ import functionals from soil (#1696)
...
- :bug: expose unexposed types in properties (#1671)
