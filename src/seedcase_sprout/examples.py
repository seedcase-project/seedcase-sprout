...
def example_resource_properties() -> ResourceProperties:
    """An example resource properties object.
...
def example_resource_properties_all_types() -> ResourceProperties:
    """An example resource properties with all Data Package types.
...
def example_data_all_types() -> pl.DataFrame:
    """An example Polars data frame with all Data Package types.
...
def example_resource_properties_all_polars_types() -> ResourceProperties:
    """An example resource properties object with all Polars types.
...
def example_data_all_polars_types() -> pl.DataFrame:
    """An example Polars data frame with all Polars data types.
